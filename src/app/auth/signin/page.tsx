...
const SignIn: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "rgb(28 36 52 / var(--tw-bg-opacity, 1))" }}
    >
      <div className="w-full max-w-3xl rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark flex flex-wrap items-center">
          ...
          <div className="w-full p-8 sm:p-12 xl:p-10">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-4 text-gray-500 dark:text-white"
                    aria-label={showPassword ? "Ocultar contraseña" : "Mostrar contraseña"}
                  >
                    {showPassword ? (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10a9.957 9.957 0 012.12-6.192M6.343 6.343a8 8 0 0111.314 0m0 11.314a8 8 0 01-11.314 0M15 12a3 3 0 11-6 0 3 3 0 016 0zM3 3l18 18" />
                      </svg>
                    ) : (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                onClick={() => {
                  // window.location.href = "URL_GOOGLE_AUTH"
                }}
              >
                <span>
                  <svg
